...
\begin{center}
\makebox[\linewidth]{\includegraphics[width=\textwidth]{HW21.jpg}}
\end{center}
...
\begin{center}
\makebox[\linewidth]{\includegraphics[width=\textwidth]{HW22.jpg}}
\end{center}
...
\textbf{(d)}\par\end{addmargin}
\end{addmargin}
\textbf{Test $H_0$ : No wheat effect against $H_1$ : there is a effect. Use $\alpha = 0.05$ if you reject H0, use Tukey’s method to do pairwise comparisons of the different wheat types.}\par
    \bigbreak
    \begin{addmargin}[-0.5em]{0em}
    \textbf{Answer: }\end{addmargin}
...
\begin{center} \makebox[\linewidth]{\includegraphics[width=\textwidth]{HW23.jpg}}
\end{center}
